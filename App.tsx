    ...
    try {
        ...
        if (publicSlug) {
            ...
            if (biz) {
                ...
                console.error("Erro ao buscar hangar pelo slug:", bizErr);
            }
        } 
